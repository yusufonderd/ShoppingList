...
import com.yonder.uicomponent.items.adapter.ItemListAdapter
import com.yonder.uicomponent.items.model.ItemUiModel
import com.yonder.uicomponent.items.model.ItemUiModelMapper
import com.yonder.uicomponent.databinding.LayoutYoFilteredItemsBinding
...
class YoItemsView @JvmOverloads constructor(
  ...
  fun bind(
    ...
    list: List<UserListProductSummaryUiModel>,
    query: String,
