...
interface LoginUseCase {
  fun login(userRegisterParam: UserRegisterParam): Flow<NetworkResult<UserUiModel>>
}
...
class LoginUseCaseImpl @Inject constructor(
  ...
  override fun login(userRegisterParam: UserRegisterParam): Flow<NetworkResult<UserUiModel>> {
    return flow {
