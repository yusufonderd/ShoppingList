...
sealed class Screen(
    ...
    object CreateNewList : Screen(Route.CREATE_NEW_LIST, R.string.create_new_list, Icons.Filled.List)
    ...
    object Language : Screen(Route.LANGUAGE, R.string.title_language_selection, Icons.Filled.Settings)
